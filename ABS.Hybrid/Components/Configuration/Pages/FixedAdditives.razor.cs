...
public partial class FixedAdditives
{
    private readonly MaterialPageService _materialPageService;

    public FixedAdditives(IServiceManager service, IDialogService dialogService, IToastService toastService)
    {
    ...
    {
        await _materialPageService.LoadMaterialsAsync("Fixed Additive");
    }
