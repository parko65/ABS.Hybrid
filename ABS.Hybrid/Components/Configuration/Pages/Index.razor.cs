...
public partial class Index
{
    ...
    public Index(IServiceManager service, IDialogService dialogService, IToastService toastService)
    {
    ...
    {
        await _materialPageService.LoadMaterialsAsync("Aggregate");
    }

    private async Task LoadMaterialsAsync()
    {
        await _materialPageService.LoadMaterialsAsync("Additive");
    }
