...
public partial class Reclaim
{
    ...
    public Reclaim(IServiceManager service, IDialogService dialogService, IToastService toastService)
    {
    ...
    {
        await _materialPageService.LoadMaterialsAsync("Reclaimed Asphalt");
    }
