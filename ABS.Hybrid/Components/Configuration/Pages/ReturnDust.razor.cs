...
public partial class ReturnDust
{
    private readonly MaterialPageService _materialPageService;

    public ReturnDust(IServiceManager service, IDialogService dialogService, IToastService toastService)
    {
    ...
    {
        await _materialPageService.LoadMaterialsAsync("Return Dust");
    }
